...
class _Config:
    ...
    BCLAWS_SFTP_HOST_KEY = os.getenv("BCLAWS_SFTP_HOST_KEY", None)
    BCLAWS_SFTP_HOST_KEY_ALGORITHM = os.getenv("BCLAWS_SFTP_HOST_KEY_ALGORITHM", "ssh-ed25519")
    ...
    BCMAIL_SFTP_HOST_KEY = os.getenv("BCMAIL_SFTP_HOST_KEY", None)
    BCMAIL_SFTP_HOST_KEY_ALGORITHM = os.getenv("BCMAIL_SFTP_HOST_KEY_ALGORITHM", "ssh-rsa")
