...
- Plan: `spec/plan.md`
- Change: `gcp-jobs/furnishings/src/furnishings/sftp.py` uses `RejectPolicy` + configured host key by default; tests fetch ephemeral host key via Transport (no AutoAddPolicy)
